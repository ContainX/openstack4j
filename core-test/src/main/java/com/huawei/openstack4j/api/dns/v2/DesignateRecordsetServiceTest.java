...
public class DesignateRecordsetServiceTest extends AbstractTest {
    ...
    public void recordsetCreateASuccessTest() throws Exception {
        ...
        Recordset recordset = osv3().dns().recordsets().create(ZONE_ID, RECORDSET_NAME, DESCRIPTION, "A", TTL, Lists.newArrayList("192.168.10.1", "192.168.10.2", "192.168.10.3"));
    ...
    public void recordsetCreateFailed2Test() throws Exception {
        osv3().dns().recordsets().create(ZONE_ID, null, DESCRIPTION, "A", TTL, Lists.newArrayList("192.168.10.1", "192.168.10.2", "192.168.10.3"));
    }

    @Test(expectedExceptions = NullPointerException.class)
    public void recordsetCreateFailed3Test() throws Exception {
        osv3().dns().recordsets().create(ZONE_ID, RECORDSET_NAME, DESCRIPTION, "A", null, Lists.newArrayList("192.168.10.1", "192.168.10.2", "192.168.10.3"));
    }
