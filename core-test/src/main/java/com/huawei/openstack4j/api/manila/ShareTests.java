...
public class ShareTests extends AbstractTest {
    ...
    public void services() throws Exception {
        ...
        List<? extends com.huawei.openstack4j.model.manila.Service> services = osv3().share().services();
        assertEquals(services.size(), 2);

        com.huawei.openstack4j.model.manila.Service service1 = services.get(0);
        com.huawei.openstack4j.model.manila.Service service2 = services.get(1);

        assertEquals(service1.getStatus(), com.huawei.openstack4j.model.manila.Service.Status.ENABLED);
        ...
        assertEquals(service1.getState(), com.huawei.openstack4j.model.manila.Service.State.UP);
        assertEquals((int) service1.getId(), 1);

        assertEquals(service2.getStatus(), com.huawei.openstack4j.model.manila.Service.Status.ENABLED);
        ...
        assertEquals(service2.getState(), com.huawei.openstack4j.model.manila.Service.State.UP);
