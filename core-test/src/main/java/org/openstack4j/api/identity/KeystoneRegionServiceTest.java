...
public class KeystoneRegionServiceTest extends AbstractTest {
    ...
    private static final String JSON_REGIONS_GET_BYID = "/identity/regions_get_byId.json";
    private static final String JSON_REGIONS_UPDATE = "/identity/regions_update_response.json";
    ...
    public void region_crud_test() throws Exception {
        ...
        Region updatedRegion = os().identity().regions()
