...
import com.huawei.openstack4j.openstack.map.reduce.domain.MapReduceNodeGroupTemplate.NodeGroupTemplates;
import com.huawei.openstack4j.openstack.map.reduce.domain.MapReduceNodeGroupTemplateUnwrapped;

/**
 * The implementation of manipulation of {@link NodeGroupTemplate}
 * 
...
public class NodeGroupTemplateServiceImpl extends BaseMapReduceServices implements NodeGroupTemplateService {
    ...
    public NodeGroupTemplate get(String templateId) {
        ...
        return get(MapReduceNodeGroupTemplate.class, uri("/node-group-templates/%s", templateId)).execute();
    }
    ...
    public NodeGroupTemplate create(NodeGroupTemplate template) {
        ...
        MapReduceNodeGroupTemplateUnwrapped unwrapped = new MapReduceNodeGroupTemplateUnwrapped(template);  
        return post(MapReduceNodeGroupTemplate.class, uri("/node-group-templates"))
