...
import com.huawei.openstack4j.openstack.sahara.domain.SaharaDataSourceUnwrapped;
import com.huawei.openstack4j.openstack.sahara.domain.SaharaDataSource.DataSources;
...
public class DataSourceServiceImpl extends BaseSaharaServices implements DataSourceService {
	...
	public DataSource create(DataSource datasource) {
		...
		return post(SaharaDataSource.class, uri("/data-sources")).entity(unwrapped) // setup request
				.execute();
	}
