...
public class HttpRequest<R> {
     ...
     *            the endpoint URI
     * @param path
     *            the path which will be appended to the endpoint URI
     * @param method
     *            the method the method type to invoke
     * @param entity
     *            the entity (used for posts)
     * @param returnType
    ...
    /**
     * If JSON is explicitly set vs an entity then this method will return a
     * JSON String otherwise Empty
     * 
    ...
    public static final class RequestBuilder<R> {
        ...
        /**
         * A Function which allows manipulation of the endpoint depending on the
         * service API utilizing it
         * 
         * @param endpointFunc
         *            the function to modify the current endpoint into a
         *            resulting endpoint
         * @return this
         */
         ...
         * 
         * @param json
         *            the JSON object in String form
         * @return the request builder
         */
