...
**NOTE**: The ```os``` used here is an instance of ```com.huawei.openstack4j.api.OSClient.OSClientV3```.
...
**NOTE**: The ```os``` used here is an instance of ```com.huawei.openstack4j.api.OSClient.OSClientV2```.
