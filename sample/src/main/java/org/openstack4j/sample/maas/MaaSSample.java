...
import org.openstack4j.openstack.maas.domain.TaskCreate.TaskCreateBuilder;
...
public class MaaSSample extends AbstractSample {
	private static final Logger LOGGER = LoggerFactory.getLogger(MaaSSample.class);
