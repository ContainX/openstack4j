...
@Test
public class DatabaseInstanceSample extends BaseTroveSample {
	...
	public void prepare() {
		...
		List<DatastoreVersion> versions = osclient.database().datastores()
				.listDatastoreVersions(org.openstack4j.openstack.database.constants.DatastoreType.MySQL);
		...
		this.datastoreVersion = this
				.getFirstDatastoreVersion(org.openstack4j.openstack.database.constants.DatastoreType.MySQL);
